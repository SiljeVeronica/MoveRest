...
MoveRest is a modern, user-friendly application designed to help you track exercise habits and daily wellbeing. It encourages healthier habits by helping you understand how your energy, discomfort, or recovery affects your activity levels.
...
- **CSS3**: Modern layout using Flexbox, Grid, and CSS Variables.
- **JavaScript (ES6+)**: Dynamic UI logic and localStorage integration.
